...
public class BaseActivity extends Activity {
	...
	public final static Show[] shows = new Show[] {
		...
		//new Show("TwitterWall (#weiqi)","org.twitterwall.show","%23weiqi"),		
		new Show("TwitterWall (#cbase)","org.twitterwall.show","%23cbase")
		//new Show("TwitterWall (#echochamber)","org.twitterwall.show","%23echochamber")		
		...
		//new Show("TwitterWall (#droidcon)","org.twitterwall.show","%23droidcon")
			...
			,new Show("GooglePlus Wall (cbase)","org.gpluswall.show","cbase")
	...
	public String getTVID() { 
		return "cbase";//Secure.getString(getApplicationContext().getContentResolver(),Secure.ANDROID_ID)+"n1_hack9";
	}
